...
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        ...
        options = $.extend({
            ...
            resetSliders: false,
            fadingEffect: false,
            normalScrollElements: '.dialog , .dialog__content , .dialog__overlay',
        ...
        */
        function createSlideArrows(section){
            section.find(SLIDES_WRAPPER_SEL).after('<div class="' + SLIDES_ARROW_PREV + '"><i class="fa fa-angle-left"></i></div><div class="' + SLIDES_ARROW_NEXT + '"><i class="fa fa-angle-right"></i></div>');
                        /* .fp-select */                /* fp-control arrow fp-previous */
        ...
        */
        function addVerticalNavigation(){
            ...
            for (var i = 0; i < $(SECTION_SEL).length; i++) {
                ...
                var li = '<li><a href="#' + link + '"><span></span>';
        ...
        */
        function afterSectionLoads (v){
            ...
            if ( $( "#menu-access i" ).is( ".ion-close-round" ) ) {
                $("#menu-access i").removeClass("ion-close-round").addClass("ion-navicon-round").toggleClass("rotateIn");
                setTimeout(function(){
